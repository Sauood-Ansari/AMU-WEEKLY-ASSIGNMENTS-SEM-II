...
class DateParseException extends DateTimeParseException {
	public DateParseException(String msg, CharSequence parseDate, int erroIndex) {
		super(msg, parseDate, erroIndex);
	}
}

public class DateParsingWithCustomException {
